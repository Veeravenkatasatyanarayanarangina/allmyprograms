 ...
 <div class="container">
            <div class="login-page">
                <div class="form">
                    ...
                    <form  action="doctordata" method="post">
                    <input type="text"  name="name" placeholder="Enter doctor Name"required="true"/>
                    ...
                    <input type="age"  name="age" placeholder="Enter doctor  Age">
                    <input type="phonenumber"  name="phone" placeholder="Enter doctor PhoneNo"/>
                    <input type="text"  name="department" placeholder="Enter doctor department"/>    
