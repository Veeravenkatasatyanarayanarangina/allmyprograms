 ...
 <div class="container">
            <div class="login-page">
                <div class="form">
                    ...
                    <input type="text"  name="name" placeholder="Enter Patient Name"required="true"/>
                    <input type="email" name="email" placeholder="Enter Patient Email" required="true"/>
                    <input type="password" name="password" placeholder="Enter Password" required="true"/>
                    <input type="age"  name="age" placeholder="Enter Patient  Age">
                    <input type="phonenumber"  name="phone" placeholder="Enter patient PhoneNo"/>   
